...
if add_to_vectorstore:
    owner = "mohamedjabri"
    repo = "advance-ai-agent"
    issues = fetch_github_issues(owner, repo)

    # Clear the vstore if we are updating it ( clear history )
    try:
    ...
    results = vstore.similarity_search("Errors", k=3)
    for res in results:
...
retriever_tool = create_retriever_tool(
    ...
    For any question about github issues, you must use this tool!"
)

# download prompt from langchain
